...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (authorization != null
            ...
            authenticateBearerToken(authorization.substring(BEARER_PREFIX.length()).trim(), request);
        }

        filterChain.doFilter(request, response);
    }

    private void authenticateBearerToken(String token, HttpServletRequest request) {
        ...
        try {
            ...
            // An unknown token subject is treated as unauthenticated.
        }
    }
}
